    ...
    private void configureBindings() {
        ...
        drivetrain.setDefaultCommand(
                ...
                drivetrain.applyRequest(() ->
                    drive.withVelocityX(
                                    -MathUtil.applyDeadband(joystick.getLeftY(), 0.06) * MaxSpeed)
                            .withVelocityY(
                                    -MathUtil.applyDeadband(joystick.getLeftX(), 0.06) * MaxSpeed)
                            .withRotationalRate(
                                    -MathUtil.applyDeadband(joystick.getRightX(), 0.06) * MaxAngularRate)));
